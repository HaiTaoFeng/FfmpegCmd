...
import com.example.ffmpegdemo.ffmpeg.model.CommandBean;
import com.example.ffmpegdemo.ffmpeg.ui.adapter.FFmpegCommandAdapter;
...
//        targetPath = getExternalCacheDir() + File.separator + "target.avi";
        ...
        targetPath = Environment.getExternalStorageDirectory().getPath() + "/demo.avi";
